...
craftingTable.addShapeless("alchemical_fuel", <item:itemalchemy:alchemical_fuel>, [<item:itemalchemy:philosopher_stone>.reuse(), <item:botania:rune_fire>, <item:minecraft:fire_charge>]);
